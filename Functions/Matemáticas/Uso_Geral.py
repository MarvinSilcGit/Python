...
def validar_cpf (cpf):
    ...
    if cpf == cpf_validador:
        ...
        return f"O CPF {formatar_cpf(cpf)} é válido, sendo emitido em {dicionario_estados[cpf[8]]}"
...
def gerador_numero_telefone_pessoal ():
    ...
    lista_ddd = ['11', '12', '13', '14', '15', '17', '16', '17', '18', '19', '21', '22', '24', '27', '28', '31',
    ...
    for contador in range(9):
        ...
        if len(numero_telefone) == 0:

            numero_telefone += aleatorio.choice(lista_ddd)

        elif len(numero_telefone) == 2:

            numero_telefone += '9'

        elif len(numero_telefone) == 3:

            bandas_prefixo = ['80', '81', '82', '83', '84', '85', '86', '87', '88', '91', '92', '93', '94', '96', '97', '98', '99']

            numero_telefone += aleatorio.choice(bandas_prefixo)

        else:

            numero_telefone += str(aleatorio.randint(0, 9))
